      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text(
              'Do you want to make an appointment on  $Datetoappointment with  '
